...
@section('heading', 'Tanbah Program Studi/Jurusan')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="info" class="form-control snote" cols="30" rows="10"></textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label>Keunggulan (EN) *</label>
                            <textarea name="info_en" class="form-control snote" cols="30" rows="10"></textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label>Keunggulan (JP) *</label>
                            <textarea name="info_jp" class="form-control snote" cols="30" rows="10"></textarea>
                        </div>
                        <div class="form-group mb-3">
