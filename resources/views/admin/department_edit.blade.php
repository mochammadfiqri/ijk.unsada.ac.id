...
@section('heading', 'Edit Program Studi/Jurusan')

@section('button')
<a href="{{ route('admin_department_show') }}" class="btn btn-primary"><i class="fas fa-eye"></i> View</a>
@endsection

@section('main_content')
<div class="section-body">
    <form action="{{ route('admin_department_update',$page_single->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <select name="faculty_id" class="form-control">
                                ...
                                <option value="{{ $row->id }}" @if($row->id == $page_single->faculty_id) selected @endif>{{ $row->title }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            <label>Keunggulan(ID) *</label>
                            <textarea name="info" class="form-control snote" cols="30" rows="10">{{ $page_single->info }}</textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label>Keunggulan (EN) *</label>
                            <textarea name="info_en" class="form-control snote" cols="30" rows="10">{{ $page_single->info_en }}</textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label>Keunggulan (JP) *</label>
                            <textarea name="info_jp" class="form-control snote" cols="30" rows="10">{{ $page_single->info_jp }}</textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label>Prospek (ID) *</label>
                            <textarea name="detail" class="form-control snote" cols="30" rows="10">{{ $page_single->detail }}</textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label>Prospek (EN) *</label>
                            <textarea name="detail_en" class="form-control snote" cols="30" rows="10">{{ $page_single->detail_en }}</textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label>Prospek (JP) *</label>
                        ...
                        <div class="form-group mb-3">
                            <label>Telp *</label>
                            <input type="text" class="form-control" id="telp" name="telp" value="{{ $page_single->telp }}">
                        </div>
                        <div class="form-group mb-3">
                            <label>Fax *</label>
                            <input type="text" class="form-control" id="fax" name="fax" value="{{ $page_single->fax }}">
                        </div>
                        <div class="form-group mb-3">
                            <label>Website</label>
                            <input type="text" class="form-control" id="url" name="url" value="{{ $page_single->url }}">
                        </div>
                        <div class="form-group mb-3">
                            <label>Active</label>
