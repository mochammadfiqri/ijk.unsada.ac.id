                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="category-page-post-item">
                                ...
                                <div class="category">
                                <span class="badge bg-success"><a href="{{ route('category',$category_data->category_slug) }}">{{ $category_data->category_name }}</a></span>
                                </div>
                                <h3><a href="{{ route('berita_detail',$item->post_slug) }}">{{ $item->post_title }}</a></h3>
                                <div class="date-user">
                                    <div class="user">
                                        @if($item->author_id==0)
                                            @php
