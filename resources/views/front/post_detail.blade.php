            ...
            <div class="col-md-12">
                ...
                <nav class="breadcrumb-container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">{{ $post_detail->category_name }}</li>
            ...
            <div class="col-lg-8 col-md-6">
                ...
                <div class="sub">
                    ...
                    <div class="item">
                        ...
                        <a href="{{ route('category',$post_detail->category_slug) }}">{{ $post_detail->category_name }}</a>
                    </div>
                    <div class="item">
                ...
                <div class="related-news">
                    ...
                    <div class="related-post-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            ...
                            <h3><a href="{{ route('berita_detail',$item->id) }}">{{ $item->post_title }}</a></h3>
                            <div class="date-user">
                                <div class="user">
                                    @if($item->author_id==0)
                                        @php
