...
class AdminServiceController extends Controller
{
    ...
    {
        $pages = Page::where('is_menu','7')->get();
        return view('admin.service_show', compact('pages'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.service_create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_service_show')->with('success', 'Data is added successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        if(!$test) {
            return redirect()->route('admin_service_show')->with('error', 'Data not found.');
        }

        $page_single = Page::where('id',$id)->first();
        return view('admin.service_edit', compact('page_single'));
    }
