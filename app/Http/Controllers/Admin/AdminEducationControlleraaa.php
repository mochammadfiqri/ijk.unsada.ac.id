...
class AdminEducationController extends Controller
{
    ...
    {
        $pages = Page::where('is_menu','2')->get();
        return view('admin.education_show', compact('pages'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.education_create', compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_education_show')->with('success', 'Data is added successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        if(!$test) {
            return redirect()->route('admin_education_show')->with('error', 'Data not found.');
        }

        $page_single = Page::where('id',$id)->first();
        return view('admin.education_edit', compact('page_single'));
    }
